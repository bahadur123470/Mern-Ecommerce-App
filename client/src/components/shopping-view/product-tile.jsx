            ...
            <div onClick={()=>handleGetProductDetails(product?._id)}>
                <div className='relative'>
                    ...
                    className='w-full h-[300px] object-cover rounded-t-lg'/>
                    {
                        ...
                        <Badge className="absolute top-2 left-2 bg-red-500 hover:bg-red-700">Out of Stock</Badge> :
                        product?.totalStock <10 ? 
                        <Badge className="absolute top-2 left-2 bg-red-500 hover:bg-red-700">{`Only ${product?.totalStock} items left`}</Badge> :
                        product?.salePrice > 0 ? (
